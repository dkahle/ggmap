...
```{r qmplot, fig.height=4, fig.width=4}
...
```{r ggmap, fig.height=4, fig.width=4}
...
```{r ggmap-layers, fig.height=4, fig.width=4}
ggmap(map) +
...
is a bit different:
```{r google_maps, fig.height=4, fig.width=4}
...
```{r route_trek, fig.height=4, fig.width=4}
