...
#' @author David Kahle \email{david.kahle@@gmail.com}, based on function XY2LatLon by Markus Loecher, Sense Networks \email{markus@@sensenetworks.com} in package RgoogleMaps
...
#' }
#' 
XY2LonLat <- function(X, Y, zoom, x = 0, y = 0, xpix=256, ypix=256){
  n <- 2^zoom
