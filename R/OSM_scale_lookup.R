...
#'
#' # the USA 
#'    lonR <- c(1.01,.99)*c(-124.733056,-66.949895)
#'    latR <- c(.99,1.01)*c(24.52083, 49.384472)
#' ggmapplot(ggmap(lonR = lonR, latR = latR, zoom =  4, 
#'   source = 'osm', scale = 32500000), fullpage = TRUE)
#' 		
#' }
#'   
#'   
